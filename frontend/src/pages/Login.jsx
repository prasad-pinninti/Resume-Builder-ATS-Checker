          ...
          <button
            ...
            onClick={async () => {
              ...
              try {
                ...
                toast.success(data.message || "A password reset link has been sent to your email!", { id: loadingToast });
              } catch (error) {
                toast.error(error?.response?.data?.message || "Failed to send password reset email.", { id: loadingToast });
              }
            }}
